...
public class TrainingPlanService
{
    ...
    {
        new PositionPlan { Position = Position.Goalkeeper, Title = "Goalkeeper Plan", Icon = "🥅", FocusSummary = "Power + agility", Description = "Explosive power, reaction training, and aerial work.", Tags = new() { "Power", "Reactions", "Aerial" } },
        new PositionPlan { Position = Position.Fullback, Title = "Full-back Plan", Icon = "🛡️", FocusSummary = "Strength + short bursts", Description = "Physical strength, short sprint recovery, and defensive positioning.", Tags = new() { "Strength", "Short sprints", "Marking" } },
        new PositionPlan { Position = Position.Midfielder, Title = "Midfielder Plan", Icon = "🔄", FocusSummary = "Endurance + repeat sprints", Description = "Repeat sprints, endurance base, and aerobic capacity.", Tags = new() { "Endurance", "Repeat sprints", "Aerobic base" } },
        new PositionPlan { Position = Position.Forward, Title = "Forward Plan", Icon = "⚡", FocusSummary = "Agility + acceleration", Description = "First-step acceleration, agility, and shooting under fatigue.", Tags = new() { "Agility", "Acceleration", "Shooting" } }
    };
}