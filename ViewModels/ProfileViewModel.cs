...
public partial class ProfileViewModel : ObservableObject
{
    ...
    [ObservableProperty] private ObservableCollection<PositionPlan> positions = new();
    [ObservableProperty] private PositionPlan? selectedPosition;
    [ObservableProperty] private string seasonModeTitle = string.Empty;
    [ObservableProperty] private string seasonModeDescription = string.Empty;
    [ObservableProperty] private bool isInSeason;
    [ObservableProperty] private bool isPreSeason;
    [ObservableProperty] private bool isOffSeason;
    ...
    private void SetSeasonMode(SeasonMode mode)
    {
        ...
        {
            SeasonMode.InSeason => ("In-season mode active", "Gym volume reduced. Focus is on match readiness and injury prevention."),
            SeasonMode.PreSeason => ("Pre-season mode active", "Build your base. High gym volume and aerobic conditioning."),
            _ => ("Off-season mode active", "Recovery and general fitness. Low load, stay active.")
        };
    }
}