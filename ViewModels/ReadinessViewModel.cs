...
public partial class ReadinessViewModel : ObservableObject
{
    ...
    [ObservableProperty] private string readinessDescription = string.Empty;
    [ObservableProperty] private double averageFeeling;
    [ObservableProperty] private double averageSoreness;
    [ObservableProperty] private int sessionsDoneThisWeek;
    [ObservableProperty] private int lastMatchMinutes;
    [ObservableProperty] private double readinessProgress;
